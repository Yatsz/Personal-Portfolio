...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Daniel Kim
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">Looking for new opportunities to broaden my horizons in the field of Computer Science!</p>
